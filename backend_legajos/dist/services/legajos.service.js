...
exports.LegajosService = {
    list: () => prisma_1.prisma.legajo.findMany({ include: { usuario: true, archivos: true } }),
    get: (id) => prisma_1.prisma.legajo.findUnique({ where: { id }, include: { usuario: true, archivos: true } }),
